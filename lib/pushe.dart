...
class Pushe {
  ...
  static Future<bool> getUserConsentStatus() async {
    ...
    return await _channel.invokeMethod("Pushe.getUserConsentStatus") ?? false;
  }
  ...
  ///
  /// Triggers a local event for inAppMessaging
  ///
  /// **NOTE**: `PusheInAppMessaging` is an optional instance and you need to enable it by adding
  /// `implementation("co.pushe.plus:inappmessaging:$latest")` in `dependencies {}` of `android/build.gradle`
  ///
  ...
  ///
  /// Checks whether InAppMessaging is enabled or not
  ///
  /// **NOTE**: `PusheInAppMessaging` is an optional instance and you need to enable it by adding
  /// `implementation("co.pushe.plus:inappmessaging:$latest")` in `dependencies {}` of `android/build.gradle`
  static Future<bool> isInAppMessagingEnabled() async {
    if(!Platform.isAndroid) return false;
    return await _channel.invokeMethod<bool>("Pushe.isInAppMessagingEnabled") ?? true;
  }

  ///
  /// Dismissed the shown InAppMessage
  ///
  /// **NOTE**: `PusheInAppMessaging` is an optional instance and you need to enable it by adding
  /// `implementation("co.pushe.plus:inappmessaging:$latest")` in `dependencies {}` of `android/build.gradle`
  ...
  ///
  /// Accepts a String which is the actual payload of an InAppMessage to show
  ///
  /// **NOTE**: `PusheInAppMessaging` is an optional instance and you need to enable it by adding
  /// `implementation("co.pushe.plus:inappmessaging:$latest")` in `dependencies {}` of `android/build.gradle`
  @visibleForTesting
  ...
  ///
  /// Sets a listener for InAppMessaging events
  ///
  /// **NOTE**: `PusheInAppMessaging` is an optional instance and you need to enable it by adding
  /// `implementation("co.pushe.plus:inappmessaging:$latest")` in `dependencies {}` of `android/build.gradle`
