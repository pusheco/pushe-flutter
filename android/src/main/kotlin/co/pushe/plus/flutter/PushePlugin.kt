 ...
 *  [PushePlugin.initialize]
 *  [PushePlugin.debugMode]
 *  [PushePlugin.registerWith] // both types
 * @author Mahdi Malvandi
 */
@Suppress("SpellCheckingInspection")
class PushePlugin : FlutterPlugin, ActivityAware {
    ...
    companion object {
         ...
         * 3. Add [PushePlugin.initialize] in `onCreate` method of the app class (override it if it does not exist).
         * 4. Add [PushePlugin.registerWith] and pass the registry in the `registerWith` method (override it if it does not exist).
        ...
        fun registerWith(registry: PluginRegistry) {
            registerWith(registry.registrarFor("co.pushe.plus.flutter.PushePlugin"))
        }
