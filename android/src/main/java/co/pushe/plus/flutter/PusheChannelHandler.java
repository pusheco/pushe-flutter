...
public class PusheChannelHandler implements MethodChannel.MethodCallHandler {
    ...
    PusheChannelHandler(Context context, BinaryMessenger messenger) {
        ...
        context.registerReceiver(new PusheNotificationReceiver(new MethodChannel(messenger, "Pushe")), i);
    }
